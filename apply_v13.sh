#!/usr/bin/env bash
# v13: bugs Huawei/recordatorios + Amen directo al inicio
set -euo pipefail
[ -f pubspec.yaml ] || exit 1

cat > 'lib/main.dart' <<'EOF_fe53fad4'
...
cat > 'lib/screens/prayer_detail/prayer_detail_screen.dart' <<'EOF_08ba373a'
import 'dart:async';
